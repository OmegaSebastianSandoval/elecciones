      ...
      <div class="  order-2 order-md-1 col-md-<?php echo ($this->tarjeton->tarjeton_mostrar_suplente == 1 || $this->tarjeton->tarjeton_mostrar_detalle == 1) ? '8' : '7'; ?>">
        ...
        <div class="row">
          ...
          <div class="col-12 order-2 order-md-1">
            <form action="/page/step3/selectcandidatemultiple" class="row login-form form-multiple" method="post" id="selectCandidateMultiple1">
                  ...
                  <thead>
                    <tr>
                      <th colspan="<?php echo $colspan ?>" class="table-title">
                        Ciudad: <?php echo $this->zonaInfo->zona ?>
                      </th>
                    </tr>
                    <tr>
                      <th colspan="2">
          ...
          <div class="col-12 order-1 order-md-2 mt-4 mt-md-0">
