                    ...
                    <?php foreach ($this->candidatos as $key => $c) { ?>
                      <tr>
                        <td style="max-width: 70px;">
                          <input type="checkbox" name="candidates[]" data-name="<?php echo $c->nombre ?>" id="candidate_<?php echo $c->id ?>" value="<?php echo $c->id ?>" class="checkbox">
          ...
          <div class="col-12 d-flex justify-content-end">
            <div class="info-text">
              <span class="text-white">
                ...
                <?php echo $this->zonaInfo->zona ?>. <br>
                <?php echo $this->tarjeton->tarjeton_descripcion ?>
                <span class="green-text mt-2">
                Por favor seleccione el candidato de su preferencia. debe seleccionar hasta <?php  ?> candidato.
                </span>
              </span>
            </div>
          </div>
