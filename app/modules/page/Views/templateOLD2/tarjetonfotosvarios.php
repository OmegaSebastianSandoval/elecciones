        ...
        <div class="row">
            <div class="col-md-7  order-2 order-md-1">
                <div class="row">
                    ...
                    <div class="col-12">
                        <form action="/page/step4" class="row login-form form-multiple" method="post" id="selectCandidate1">
                            <div class="grid-container gridmulti-check">
                                ...
                                <?php foreach ($this->candidatos as $key => $c) { ?>
                                    <div class="grid-item">
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="checkbox" name="candidates[]" data-name="<?php echo $c->nombre ?>" id="candidate_<?php echo $c->id ?>" value="<?php echo $c->id ?>">
