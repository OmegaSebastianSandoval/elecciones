<div class="general-container login-container step3-container">
  <div class="container">
    <div class="row">
      <div class="col-md-<?php echo ($this->tarjeton->tarjeton_mostrar_suplente == 1 || $this->tarjeton->tarjeton_mostrar_detalle == 1) ? '8' : '7'; ?>   order-2 order-md-1">
        <div class="row">
          <div class="col-12">
            <h3 class="title-one">Proceso electoral 1 SOLO</h3>
          </div>
          ...
          ?>
          <div class="col-12">
            <form action="/page/step3/selectcandidatemultiple" class="row login-form formulario-eleccion" method="post" id="">
              <input type="hidden" name="tarjeton-actual">
              <div class="table-container">
                <table>
                  <thead>
                    <tr>
                      <th colspan="<?php echo $colspan ?>" class="table-title">
                        Zona: <?php echo $this->list_zonas[$this->tarjeton->tarjeton_zona] ?>
                    ...
                    <?php foreach ($this->candidatos as $key => $c) { ?>
                      <tr>
                        <td style="max-width: 70px;">
                          ...
                          <input type="radio" name="candidate" id="candidate_<?php echo $c->id ?>" value="<?php echo $c->id ?>" class="radio">
