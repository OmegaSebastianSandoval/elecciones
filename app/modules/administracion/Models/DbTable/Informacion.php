...
class Administracion_Model_DbTable_Informacion extends Db_Table
{
	...
	public function insert($data){
		...
		$info_pagina_host2 = $data['info_pagina_host2'];
		$info_pagina_port2 = $data['info_pagina_port2'];
		$info_pagina_username2 = $data['info_pagina_username2'];
		$info_pagina_password2 = $data['info_pagina_password2'];
		$info_pagina_correo_remitente2 = $data['info_pagina_correo_remitente2'];
		$info_pagina_nombre_remitente2 = $data['info_pagina_nombre_remitente2'];
		$info_pagina_correo_oculto2 = $data['info_pagina_correo_oculto2'];
