...
{
	protected $namepages;
	protected $botonpanel;
	protected $votacionActiva;
	...
	public function init()
	{
		...
		$this->_view->votacionActiva = $this->votacionActiva;
		$this->setLayout('administracion_panel');

		$eleccionesModel = new Administracion_Model_DbTable_Configvotacion();
		$order = "id DESC";
		$this->_view->listadoElecciones =  $eleccionesModel->getList("", $order);
		$validosConfiguracion = [2, 7, 5, 10, 6, 8];
		$this->_view->botonActivoConfiguracion = in_array($this->botonpanel, $validosConfiguracion) ? 1 : false;
