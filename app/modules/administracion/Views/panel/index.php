<div class="container-fluid">
	...
	<div class="row">
		<div class="col-6 col-xl-6">
			<div class="div-dashboard">
				<h2>
					<img src="/skins/administracion/images/redessociales.png">
					Logo
					<a href="/administracion/informacion/#logos">
						<i class="fas fa-marker"></i>
					</a>
				</h2>
				<div align="center" class="redesFavicon">
					<?php if ($this->info->info_logo) { ?>
						<div><img src="/images/<?= $this->info->info_logo; ?>" style="width: 72px;max-width: 72px;"></div>
					<?php } else { ?>
						<div><img class="style_btn_nofavicon" src="/images/noexiste.png"></i></div>
						<div><img src="/skins/administracion/images/x.png"></i></div>
					<?php } ?>
		...
		<div class="col-6 col-xl-6">
			<div class="div-dashboard">
				...
				<div align="center" class="redesFavicon">
					<?php if ($this->info->info_logo_grande) { ?>
						<div><img src="/images/<?= $this->info->info_logo_grande; ?>" style="width: 72px;max-width: 72px;"></div>
					<?php } else { ?>
						<div><img class="style_btn_nofavicon" src="/images/noexiste.png"></i></div>
						<div><img src="/skins/administracion/images/x.png"></i></div>
					<?php } ?>
	...
	<div class="div-dashboard">
		<h2>
			<img src="/skins/administracion/images/informaciondecotactenos.png"> Configuración Envio Correo Secundario <a href="/administracion/informacion#configcorreo2"><i class="fas fa-marker"></i></a>
		</h2>
		<div class="pading-dashboard" style=" margin-top: 2%;padding-bottom: 6px;">
					...
					<table class="table table-bordered">
						<tbody>
							<tr>
								<th scope="row">Host</th>
								<td>
									<span><?= $this->info->info_pagina_host2; ?></span>
								</td>
								<th scope="row">Correo remitente</th>
								<td>
									<span><?= $this->info->info_pagina_correo_remitente2; ?></span>


								</td>
								<th scope="row">Username</th>
								<td>
									<span><?= $this->info->info_pagina_username2; ?></span>


								</td>
								<!--<th scope="row">Password</th>
								<td>
									<span><?= $this->info->info_pagina_password2; ?></span>
							...
							<tr>
								...
								<th scope="row">Port</th>
								<td>
									<span><?= $this->info->info_pagina_port2; ?></span>

								</td>
								<th scope="row">Nombre remitente</th>
								<td>
									<span><?= $this->info->info_pagina_nombre_remitente2; ?></span>


								</td>
								<th scope="row">Correo oculto</th>
								<td>
									<span><?= $this->info->info_pagina_correo_oculto2; ?></span>
