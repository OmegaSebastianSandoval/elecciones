        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="config_login_imagen" value="<?php echo $this->getObjectVariable($this->filters, 'config_login_imagen') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>Titulo</label>
		            ...
		            <input type="text" class="form-control" name="config_login_titulo" value="<?php echo $this->getObjectVariable($this->filters, 'config_login_titulo') ?>"></input>
		            </label>
		        </div>
						<div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->config_login_id; ?>
					<tr>
						<td>
							<?php if($content->config_login_imagen) { ?>
								<img src="/images/<?= $content->config_login_imagen; ?>"  class="img-thumbnail thumbnail-administrator" />
							<?php } ?>
							<div><?= $content->config_login_imagen; ?></div>
						</td>
						<td><?=$content->config_login_titulo;?></td>
						<td class="text-right">
							<div>
