<div class="container-fluid">
			...
			<div align="center" class="pading-dashboard">
				...
				<div class="row">
					<div class="col-12 form-group">
						<input type="file" name="info_pagina_favicon" id="info_pagina_favicon" class="form-control  file-image" data-buttonName="btn-primary" accept="image/ico" <?php if (!$this->content->info_pagina_favicon) { echo 'required'; } ?>>
    ...
    <div class="row px-3">
      <div class="div-dashboard col-6">
        <h2>
          <img src="/skins/administracion/images/redessociales.png"> Logo
        </h2>
        <div align="center" class="pading-dashboard">
          <br>
          <div class="row">
            <div class="col-12 form-group">
              <input type="file" name="info_logo" id="info_logo" class="form-control  file-image" data-buttonName="btn-primary" accept="image/ico" <?php if (!$this->content->info_logo) { echo 'required'; } ?>>
              <div class="help-block with-errors"></div>
              <?php if ($this->content->info_logo) { ?>
                <div id="imagen_info_pagina_favicon">
                  <img src="/images/<?= $this->content->info_logo; ?>" class="img-thumbnail thumbnail-administrator" />
                  <div><button class="btn btn-danger btn-sm" type="button" onclick="eliminarImagen('info_pagina_favicon','<?php echo $this->route . "/deleteimage"; ?>')"><i class="glyphicon glyphicon-remove"></i> Eliminar Imagen</button></div>
                </div>
              <?php } ?>
            </div>
      ...
      <div class="div-dashboard col-6">
        <h2>
          <img src="/skins/administracion/images/redessociales.png"> Logo grande
        </h2>
        <div align="center" class="pading-dashboard">
          <br>
          <div class="row">
            <div class="col-12 form-group">
              <input type="file" name="info_logo_grande" id="info_logo_grande" class="form-control  file-image" data-buttonName="btn-primary" accept="image/ico" <?php if (!$this->content->info_logo_grande) { echo 'required'; } ?>>
              <div class="help-block with-errors"></div>
              <?php if ($this->content->info_logo_grande) { ?>
                <div id="imagen_info_pagina_favicon">
                  <img src="/images/<?= $this->content->info_logo_grande; ?>" class="img-thumbnail thumbnail-administrator" />
                  <div><button class="btn btn-danger btn-sm" type="button" onclick="eliminarImagen('info_pagina_favicon','<?php echo $this->route . "/deleteimage"; ?>')"><i class="glyphicon glyphicon-remove"></i> Eliminar Imagen</button></div>
                </div>
              <?php } ?>
            </div>
		...
		<div class="div-dashboard">
			...
			<a id="configcorreo2" name="configcorreo2"></a>
		<div class="div-dashboard">
			<h2>
				<img src="/skins/administracion/images/informaciondecotactenos.png"> Configuración Envio Correo Secundario
			</h2>
			<div class="pading-dashboard">
				<br>
						...
						<table class="table table-bordered table-striped">
							<tbody>
								<tr>
									<th scope="row">Host</th>
									<td>
										<input class="input_correo" type="text" name="info_pagina_host2" id="info_pagina_host2" value="<?= $this->content->info_pagina_host2; ?>" required>
									</td>
								...
								<tr>
									<th scope="row">Port</th>
									<td>
										<input class="input_correo" type="number" name="info_pagina_port2" id="info_pagina_port2" value="<?= $this->content->info_pagina_port2; ?>" required>
								...
								<tr>
									<th scope="row">Username</th>
									<td>
										<input class="input_correo" type="text" name="info_pagina_username2" id="info_pagina_username2" value="<?= $this->content->info_pagina_username2; ?>" required>
								...
								<tr>
									<th scope="row">Password</th>
									<td>
										<input class="input_correo" type="password" name="info_pagina_password2" id="info_pagina_password2" value="<?= $this->content->info_pagina_password2; ?>" required>
								...
								<tr>
									<th scope="row">Correo remitente</th>
									<td>
										<input class="input_correo" type="text" name="info_pagina_correo_remitente2" id="info_pagina_correo_remitente2" value="<?= $this->content->info_pagina_correo_remitente2; ?>" required>
								...
								<tr>
									<th scope="row">Nombre remitente</th>
									<td>
										<input class="input_correo" type="text" name="info_pagina_nombre_remitente2" id="info_pagina_nombre_remitente2" value="<?= $this->content->info_pagina_nombre_remitente2; ?>" required>
								...
								<tr>
									<th scope="row">Correo oculto</th>
									<td>
										<input class="input_correo" type="text" name="info_pagina_correo_oculto2" id="info_pagina_correo_oculto2" value="<?= $this->content->info_pagina_correo_oculto2; ?>">
