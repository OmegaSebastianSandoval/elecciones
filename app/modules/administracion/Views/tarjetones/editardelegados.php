...
<div class="container-fluid">
	<form class="text-left" enctype="multipart/form-data" method="post" action="/administracion/tarjetones/updatedelegados" data-bs-toggle="validator">
		<div class="content-dashboard">
			...
			<div class="row">
				<div class="col-12 text-end mb-3" align="right">
					<a href="/skins/page/files/ejemplocandidatos.xlsx" class="custom-btn-home me-2">
				...
				<input type="hidden" name="tarjeton" value="<?php echo $this->tarjeton; ?>">

				<div class="col-12 form-group">
					<label for="archivo" class="form-label">Archivo de Delegados</label>
		...
		<div class="botones-acciones">
			...
			<a href="<?php echo $this->route; ?>?eleccion=<?php echo $this->votacion; ?>" class="btn btn-cancelar">Cancelar</a>
		</div>
	</form>
</div>