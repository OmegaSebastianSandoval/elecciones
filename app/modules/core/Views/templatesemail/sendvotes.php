<div style=" background: #6e6e6e20; padding: 10px; font-size: 15px;">
    ...
    <thead>
      <tr>
        <th colspan="4" class="table-title">
          <h1 style="border:0;color:#ffffff;font-weight:400;margin:0;outline:0;padding:0;"> Certificado de votaci&oacute;n N° <?php echo $this->consecutivo ?></h1>
        </th>
      </tr>
    ...
    <thead>
      <tr>
        <th colspan="4" style="padding-top: 10px; padding-bottom: 10px; border:0;color:#222;font-family:HMSans,Arial,sans-serif;font-size:16px;font-weight:400;line-height:20px;margin:0;outline:0;text-decoration:none">
          <?php echo  $this->tarjeton->tarjeton_nombre ?>
        </th>
      </tr>
  ...
  <table style="width: 100%; margin-bottom:30px;">
    ...
    <tbody>
      <?php foreach ($this->candidate as $candidate) { ?>

        <tr>
          <td style="max-width: 30px;">
            <div style="text-align:center">
              <?php if ($candidate->foto) { ?>
                <img src="/images/<?php echo $candidate->foto ?>" alt="Foto del cantidato" style="width:100px;height:100px">
              <?php } else { ?>
                <img src="/skins/page/images/user-solid.png" alt="Foto del cantidato" style="width:100px;height:100px">
              <?php } ?>
            </div>
          ...
          <td style="text-align:center">
            <span class="city-candidate">
              <?php echo $list_zona[$candidate->zona] ?>
            </span>
          </td>
        </tr>
      <?php } ?>
